#!/usr/bin/env python3
"""Generate the Bangalore Morning Digest for September 11, 2026."""
...
OUTPUT = os.path.join(DIR, "digest_2026-09-11.html")

DATE_LONG  = "Friday, 11 September 2026"
TIME_IST   = "9:00 AM IST"
TITLE_DATE = "September 11, 2026"

SYSTEM = """\
You are a news curator for the Bangalore Morning Digest. Today is Friday, 11 September 2026.
...
def fetch_news() -> dict:
    ...
    msgs   = [{"role": "user", "content": (
        "Search for the top news stories for September 11, 2026 across all five categories "
