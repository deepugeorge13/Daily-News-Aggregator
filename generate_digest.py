#!/usr/bin/env python3
"""Generate the Bangalore Morning Digest for June 29, 2026."""
...
OUTPUT = os.path.join(DIR, "digest_2026-06-29.html")

DATE_LONG  = "Sunday, 29 June 2026"
TIME_IST   = "9:00 AM IST"
TITLE_DATE = "June 29, 2026"

SYSTEM = """\
You are a news curator for the Bangalore Morning Digest. Today is Sunday, 29 June 2026.
...
def fetch_news() -> dict:
    ...
    msgs   = [{"role": "user", "content": (
        "Search for the top news stories for June 29, 2026 across all five categories "
