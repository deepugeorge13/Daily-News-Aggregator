#!/usr/bin/env python3
"""Generate the Bangalore Morning Digest for July 7, 2026."""
...
OUTPUT = os.path.join(DIR, "digest_2026-07-07.html")

DATE_LONG  = "Tuesday, 7 July 2026"
TIME_IST   = "9:00 AM IST"
TITLE_DATE = "July 7, 2026"

SYSTEM = """\
You are a news curator for the Bangalore Morning Digest. Today is Tuesday, 7 July 2026.
...
def fetch_news() -> dict:
    ...
    msgs   = [{"role": "user", "content": (
        "Search for the top news stories for July 7, 2026 across all five categories "
