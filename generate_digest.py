#!/usr/bin/env python3
"""Generate the Bangalore Morning Digest for August 13, 2026."""
...
OUTPUT = os.path.join(DIR, "digest_2026-08-13.html")

DATE_LONG  = "Thursday, 13 August 2026"
TIME_IST   = "9:00 AM IST"
TITLE_DATE = "August 13, 2026"

SYSTEM = """\
You are a news curator for the Bangalore Morning Digest. Today is Thursday, 13 August 2026.
...
def fetch_news() -> dict:
    ...
    msgs   = [{"role": "user", "content": (
        "Search for the top news stories for August 13, 2026 across all five categories "
