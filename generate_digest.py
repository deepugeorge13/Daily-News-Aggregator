#!/usr/bin/env python3
"""Generate the Bangalore Morning Digest for July 5, 2026."""
...
OUTPUT = os.path.join(DIR, "digest_2026-07-05.html")

DATE_LONG  = "Saturday, 5 July 2026"
TIME_IST   = "9:00 AM IST"
TITLE_DATE = "July 5, 2026"

SYSTEM = """\
You are a news curator for the Bangalore Morning Digest. Today is Saturday, 5 July 2026.
...
def fetch_news() -> dict:
    ...
    msgs   = [{"role": "user", "content": (
        "Search for the top news stories for July 5, 2026 across all five categories "
