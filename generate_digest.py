#!/usr/bin/env python3
"""Generate the Bangalore Morning Digest for September 9, 2026."""
...
OUTPUT = os.path.join(DIR, "digest_2026-09-09.html")

DATE_LONG  = "Wednesday, 9 September 2026"
TIME_IST   = "9:00 AM IST"
TITLE_DATE = "September 9, 2026"

SYSTEM = """\
You are a news curator for the Bangalore Morning Digest. Today is Wednesday, 9 September 2026.
...
def fetch_news() -> dict:
    ...
    msgs   = [{"role": "user", "content": (
        "Search for the top news stories for September 9, 2026 across all five categories "
