#!/usr/bin/env python3
"""Generate the Bangalore Morning Digest for September 21, 2026."""
...
OUTPUT = os.path.join(DIR, "digest_2026-09-21.html")

DATE_LONG  = "Monday, 21 September 2026"
TIME_IST   = "9:00 AM IST"
TITLE_DATE = "September 21, 2026"

SYSTEM = """\
You are a news curator for the Bangalore Morning Digest. Today is Monday, 21 September 2026.
...
def fetch_news() -> dict:
    ...
    msgs   = [{"role": "user", "content": (
        "Search for the top news stories for September 21, 2026 across all five categories "
