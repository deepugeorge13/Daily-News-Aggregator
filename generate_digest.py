#!/usr/bin/env python3
"""Generate the Bangalore Morning Digest for August 4, 2026."""
...
OUTPUT = os.path.join(DIR, "digest_2026-08-04.html")

DATE_LONG  = "Tuesday, 4 August 2026"
TIME_IST   = "9:00 AM IST"
TITLE_DATE = "August 4, 2026"

SYSTEM = """\
You are a news curator for the Bangalore Morning Digest. Today is Tuesday, 4 August 2026.
...
def fetch_news() -> dict:
    ...
    msgs   = [{"role": "user", "content": (
        "Search for the top news stories for August 4, 2026 across all five categories "
