#!/usr/bin/env python3
"""Generate the Bangalore Morning Digest for July 11, 2026."""
...
OUTPUT = os.path.join(DIR, "digest_2026-07-11.html")

DATE_LONG  = "Saturday, 11 July 2026"
TIME_IST   = "9:00 AM IST"
TITLE_DATE = "July 11, 2026"

SYSTEM = """\
You are a news curator for the Bangalore Morning Digest. Today is Saturday, 11 July 2026.
...
def fetch_news() -> dict:
    ...
    msgs   = [{"role": "user", "content": (
        "Search for the top news stories for July 11, 2026 across all five categories "
